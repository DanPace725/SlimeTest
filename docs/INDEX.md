...
* **Signal Field analytics** – Opt-in telemetry for channel coherence remains experimental; cross-verify terminology and screenshots before publishing externally.【F:docs/architecture/SIGNAL_FIELD_SYSTEM_OVERVIEW.md†L1-L35】
* **TC resource overlay** – The Rule 110 integration scripts require manual toggles and console setup; treat the quickstart guide as experimental until the UI flow is redesigned.【F:docs/how-to/TC_RESOURCE_QUICKSTART.md†L1-L120】
